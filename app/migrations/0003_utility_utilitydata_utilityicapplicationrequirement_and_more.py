# Generated by Django 5.2.5 on 2025-08-26 03:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0002_ahj_ahjelectricalrequirement_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.BigIntegerField(default=genesis.utils.current_timestamp)),
                ('updated_at', models.BigIntegerField(default=genesis.utils.current_timestamp)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='zipcode_utility_created', to='app.user')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='zipcode_utility_updated', to='app.user')),
                ('utility', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.utility')),
            ],
            options={
